...
exports.getAllStudents = async (req, res) => {
  try {
    ...
    const students = await Student.findAndCountAll({
      ...
      // Sorted by admission number (not last name) so the Students page —
      // and every page of its pagination — lists students in the same
      // predictable order the rest of the system (Enrollments, Reports)
      // now uses.
